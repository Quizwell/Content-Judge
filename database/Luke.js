			...
			chapters: [
				{
					sections: [
						...
						{
							title: "The Birth of John the Baptist Foretold",
							verses: [
					...
					footnotes: {
						a: "Or _been surely believed_",
						b: "Or _So the child to be born will be called holy,_",
						c: "Horn here symbolizes a strong king.",
						d: "Or _in the Spirit_",
					},
				},
				{
					sections: [
					...
					footnotes: {
						a: "Or _This census took place before_",
						b: "Exodus 13:2,12",
						c: "Lev. 12:8",
				...
				},
				{
					sections: [
						...
						{
							title: "The Baptism and Genealogy of Jesus",
							verses: [
					...
					footnotes: {
						...
						b: "Or _in_",
						c: "Or _in_",
						d: "Some early manuscripts _Sala_",
						e: "Some manuscripts _Amminadab, the son of Admin, the son of Arni_; other manuscripts vary widely.",
					},
				},
				{
					sections: [
						...
						{
							title: "Jesus Rejected at Nazareth",
							verses: [
						...
						{
							title: "Jesus Drives Out an Impure Spirit",
							verses: [
					...
					footnotes: {
						a: "The Greek for _tempted_ can also mean _tested_.",
						b: "Deut. 8:3",
						c: "Deut. 6:13",
						d: "Psalm 91:11,12",
						e: "Deut. 6:16",
						f: "Isaiah 61:1,2 (see Septuagint); Isaiah 58:6",
						g: "The Greek word traditionally translated _leprosy_ was used for various diseases affecting the skin.",
					},
				},
				{
					sections: [
						...
						{
							title: "Jesus Calls Levi and Eats With Sinners",
							verses: [
						...
						{
							title: "Jesus Questioned About Fasting",
							verses: [
				...
				},
				{
					sections: [
						...
						{
							title: "Jesus Anointed by a Sinful Woman",
							verses: [
				...
				},
				{
					sections: [
						...
						{
							title: "Jesus Restores a Demon-Possessed Man",
							verses: [
					...
					footnotes: {
						a: "Isaiah 6:9",
						b: "Some manuscripts _Gadarenes_; other manuscripts _Gergesenes_; also in verse 37",
						c: "Many manuscripts _years, and she had spent all she had on doctors_",
					},
				},
				{
					sections: [
						...
						{
							title: "Peter Declares That Jesus Is the Messiah",
							verses: [
						...
						{
							title: "Jesus Heals a Demon-Possessed Boy",
							verses: [
								...
								"And they were all amazed at the greatness of God. {SECTION} While everyone was marveling at all that Jesus did, he said to his disciples,",
							],
						},
						{
							title: "Jesus Predicts His Death a Second Time",
							verses: [
					...
					footnotes: {
						a: "Greek _exodos_",
						b: "Some manuscripts _them, just as Elijah did_",
					},
				},
				{
					sections: [
						{
							title: "Jesus Sends Out the Seventy-Two",
							verses: [
						...
						{
							title: "At the Home of Martha and Mary",
							verses: [
					...
					footnotes: {
						a: "Some manuscripts _seventy_; also in verse 17",
						b: "That is, the realm of the dead",
						c: "Deut. 6:5",
						d: "Lev. 19:18",
						e: "A denarius was the usual daily wage of a day laborer (see Matt. 20:2).",
						f: "Some manuscripts _but only one thing is needed_",
					},
				},
				{
					sections: [
						...
						{
							title: "Woes on the Pharisees and the Experts in the Law",
							verses: [
					...
					footnotes: {
						a: "Some manuscripts _Our Father in heaven_",
						b: "Some manuscripts _come. May your will be done on earth as it is in heaven._",
						c: "Greek _everyone who is indebted to us_",
						d: "Some manuscripts _temptation, but deliver us from the evil one_",
						e: "Or _yet to preserve his good name_",
						f: "Some manuscripts _for bread, will give him a stone? Or if he asks for_",
						g: "The Greek for _healthy_ here implies _generous_.",
						h: "The Greek for _unhealthy_ here implies _stingy_.",
					},
				},
				{
					sections: [
					...
					footnotes: {
						a: "Or _speak to his disciples, saying: “First of all, be_",
						b: "Or _single cubit to your height_",
					},
				},
				{
					sections: [
						...
						{
							title: "Jesus Heals a Crippled Woman on the Sabbath",
							verses: [
						...
						},
						{
							...
							verses: [
								...
								'It is like yeast that a woman took and mixed into about sixty pounds[a] of flour until it worked all through the dough."',
							],
						},
						{
						...
						{
							title: "Jesus’ Sorrow for Jerusalem",
							verses: [
				...
				},
				{
					sections: [
						{
							title: "Jesus at a Pharisee’s House",
							verses: [
				...
				},
				{
					...
					footnotes: {
						a: "Greek _ten drachmas_, each worth about a day’s wages",
					},
				},
				{
					sections: [
				...
				},
				{
					...
					footnotes: {
						a: "The Greek word for _brother or sister_ (_adelphos_) refers here to a fellow disciple, whether man or woman.",
						b: "The Greek word traditionally translated _leprosy_ was used for various diseases affecting the skin.",
						c: "Or _is within you_",
						d: "Some manuscripts do not have _in his day_.",
				...
				},
				{
					sections: [
						...
						{
							title: "The Little Children and Jesus",
							verses: [
						...
						{
							title: "Jesus Predicts His Death a Third Time",
							verses: [
						...
						{
							title: "A Blind Beggar Receives His Sight",
							verses: [
				...
				},
				{
					sections: [
						...
						{
							title: "Jesus Comes to Jerusalem as King",
							verses: [
				...
				},
				{
					sections: [
						{
							title: "The Authority of Jesus Questioned",
							verses: [
						...
						{
							title: "Whose Son Is the Messiah?",
							verses: [
				...
				},
				{
					sections: [
						...
						{
							title: "The Destruction of the Temple and Signs of the End Times",
							verses: [
				...
				},
				{
					sections: [
						...
						{
							title: "Jesus Before Pilate and Herod",
							verses: [
					...
					footnotes: {
						a: "Some manuscripts do not have _given for you … poured out for you._",
						b: "Isaiah 53:12",
				...
				},
				{
					sections: [
						{
							title: "Jesus Before Pilate and Herod (Continued)",
							verses: [
					...
					footnotes: {
						...
						b: "Hosea 10:8",
						c: "Some early manuscripts do not have this sentence.",
						d: "Some manuscripts _come with your kingly power_",
						e: "Psalm 31:5",
					},
				},
				{
...
Luke.concordance = generateConcordance(Luke);
