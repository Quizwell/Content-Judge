var flyswatter = {
	sendBugReport: function (optionID) {
		...
		var body = `Content Judge Version ${CONTENT_JUDGE_VERSION}%0D%0A${optionID}%0D%0APlease mention as much as possible about the problem you are experiencing below this line.`;
